...
//            ,"Tan Tock Seng Hospital","KK Women's and Children's Hospital"," Manual Input "};
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == android.R.id.home) {
            ...
            return true;
            //add button
        }  else if (id == R.id.action_select_clinic) {
            Intent addMed = new Intent(MainActivity.this, AddMedActivity.class);
            addMed.putExtra("PREV_ACTIVITY", TAG);
            startActivity(addMed);
//            displaySelectClinicDialog();
            return true;
        }
    ...
    // This method sets the variable clinicId
    // By default clinicId = -1
    public void setClinicId(int clinicId){
        this.mClinidId = clinicId;
    }

    /**
     * This method displays the clinic dialog used to add new medication
     * */
//    private void displaySelectClinicDialog() {
//        AlertDialog alertDialog;
//        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this, R.style.Theme_AppCompat);
//        builder.setTitle("Select Medical Clinic");
//        builder.setSingleChoiceItems(mClinicValues, -1, new DialogInterface.OnClickListener() {
//            public void onClick(DialogInterface dialog, int item) {
//                int selectedPosition = ((AlertDialog)dialog).getListView().getCheckedItemPosition();
//                setClinicId(selectedPosition);
//            }
//        });
//
...
//                Intent addMed = new Intent(MainActivity.this, AddMedActivity.class);
//                addMed.putExtra("PREV_ACTIVITY", TAG);
//                if(mClinidId < (mClinicValues.length -1)){
//                    addMed = new Intent(MainActivity.this, ScanMedActivity.class);
//                    // Adds an additional CLINIC_ID to identify CLINIC
//                    addMed.putExtra("CLINIC_ID", mClinidId);
//                }
//                startActivity(addMed);
//            }
//        });
